function xdot = nonlinear_plant2(x, angle_ox, angle_ipa, t)
    ...
    P_out_ox = x(5);
    P_out_ipa = x(6);
    distMode = 0;           % 1 for disturbances, 0 for none

    %Data
    ox_tank_pressure = 820 + distMode * 35*sin(7*t); % psi, with disturbance
    ipa_tank_pressure = 820 + distMode * 35*sin(2*t); % psi, with disturbance
